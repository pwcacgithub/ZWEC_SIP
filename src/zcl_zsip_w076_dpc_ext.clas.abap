class ZCL_ZSIP_W076_DPC_EXT definition
  public
  inheriting from ZCL_ZSIP_W076_DPC
  create public .
...
CLASS ZCL_ZSIP_W076_DPC_EXT IMPLEMENTATION.
...
*****************************************************************************
    ...
    DATA : lo_request_context    TYPE REF TO /iwbep/if_mgw_req_entity_c,
           ...
           lw_header             TYPE zcl_zsip_w076_mpc=>ts_header,
           lw_items              TYPE zcl_zsip_w076_mpc=>ts_item,
           lw_items_inactive     TYPE zcl_zsip_w076_mpc=>ts_iteminactive,
           lw_deep_struc         TYPE zscu_deep_struc,
           lw_attach_ui          TYPE zcl_zsip_w076_mpc=>ts_attachmentheader,
           lw_attachheader       TYPE zcl_zsip_w076_mpc=>ts_attachmentheader,
           lw_routing            TYPE zcl_zsip_w076_mpc=>ts_approvalflow,
...
*****************************************************************************
    DATA: lv_msg       TYPE bapi_msg,
          ...
          lw_return    TYPE zcl_zsip_w076_mpc=>ts_return,
          lw_approvers TYPE zcl_zsip_w076_mpc=>ts_auditlog_approvers,
          lt_return    TYPE zcl_zsip_w076_mpc=>tt_return.
...
**----------------------------------------------------------------------*
    ...
    DATA : lw_stream         TYPE ty_s_media_resource,
           ...
           lv_error_flag     TYPE boolean,
           lw_converted_keys TYPE zcl_zsip_w076_mpc=>ts_attachmentheader.
...
*****************************************************************************
    ...
    DATA : lw_approvalflow TYPE zcl_zsip_w076_mpc=>ts_approvalflow.
...
*Local Variables
*----------------------------------------------------------------------*
    DATA : lw_converted_keys TYPE zcl_zsip_w076_mpc=>ts_attachmentheader,
           lv_error_flag     TYPE boolean,
           lv_err            TYPE string.
...
***Call Utility class for data
    zclcu_sip_utility=>get_attachment_header_new(
      EXPORTING
...
*****************************************************************************
    ...
    DATA : lw_header TYPE zcl_zsip_w076_mpc=>ts_header,
           lt_header TYPE zcl_zsip_w076_mpc=>tt_header.
...
*****************************************************************************
    ...
    DATA : lw_item TYPE zcl_zsip_w076_mpc=>ts_item.
...
*&  Transport Request No   : D10K934677
*****************************************************************************
    DATA ls_ticket TYPE zcl_zsip_w076_mpc=>ts_ticketsearchhelp.
...
*    DATA : lw_wrsp TYPE zcl_zsip_w076_mpc=>ts_wrspsearchhelp,
*           lv_user     TYPE uname.
